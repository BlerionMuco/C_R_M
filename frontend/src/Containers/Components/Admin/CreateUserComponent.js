...
const CreateUserComponent = () => {
    ...
    const createUser = () => {
        dispatch(createUserAsync({
            dataForm, callThunk: () => {
                setDataForm({ first_name: "", last_name: "", username: "", user_password: "", user_verification_password: "", email: "", age: "", phone_number: "", role_id: 3 })
            }
        }))
    }
    return (
        <div>
            ...
            <div style={{ display: "flex", marginTop: "14px", justifyContent: "end" }}>
                <Button onClick={createUser} color="success" variant="contained">Create</Button>
            </div>
        </div>
    )
}
