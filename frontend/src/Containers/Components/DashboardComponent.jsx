      ...
      >
        ...
        <List sx={{ margin: "0 10px", height: "100vh" }}>
            ...
            <ListItem
              sx={
                window.location.pathname === menu.pathname
                  ...
                  : { background: "", marginBottom: "8px" }
              }
              key={menu.id}
              disablePadding
              onClick={() => redirect(menu.redirect)}
            >
              <ListItemButton>
                ...
                <List component="div" disablePadding>
                  {childMenuList &&
                    childMenuList.map((childMenu) => {
                      return (
                        <ListItemButton
                          onClick={() => redirect(childMenu.redirect)}
                          sx={
                            window.location.pathname === childMenu.pathname ||
                            window.location.pathname === childMenu?.subPathname
                              ? {
                                  background: "#CFCFD1",
                                  borderRadius: "8px",
                                  marginBottom: "8px",
                              ...
                              : { background: "", marginBottom: "8px", pl: 4 }
                          }
                          key={childMenu.id}
                        >
                          <ListItemIcon>{childMenu.icon}</ListItemIcon>
          ...
          <Button
            ...
            sx={{ position: "absolute", width: "100%", bottom: "10px" }}
          >
            Log Out
          </Button>
        </List>
