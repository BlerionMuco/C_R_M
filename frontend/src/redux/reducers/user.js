...
export const updateUserPassword = createAsyncThunk(
  ...
  async ({ userId, user_password, current_password }) => {
    const { data } = await axios.put(
      process.env.REACT_APP_BACKEND_URL + `/api/users/${userId}/updatePassword`,
      { user_password: user_password, current_password: current_password }
    );
    if (!data) return;
    return data;
  }
